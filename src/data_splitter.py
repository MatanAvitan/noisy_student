import os
from consts import TRAIN_SPLIT_PERCENTAGES, STUDENT_TEACHER_LOOP, COCOSPLIT_PATH, ANNOTATIONS_DIR, NEW_ANNOTATIONS_DIR, ORIGINAL_ANNOTATIONS_DIR, ORIGINAL_TRAIN_ANNOTATION_FILE
